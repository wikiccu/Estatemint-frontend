    ...
    <form className="grid gap-4">
      <label className="grid gap-2 text-sm font-bold text-zinc-800">
        ...
        <span className="relative">
          ...
          <input
            className="h-12 w-full rounded-md border border-stone-200 bg-stone-50 pr-11 pl-4 font-normal outline-none transition placeholder:text-zinc-400 focus:border-[#173f35] focus:bg-white"
      ...
      <label className="grid gap-2 text-sm font-bold text-zinc-800">
        ...
        <span className="relative">
          ...
          <select className="h-12 w-full rounded-md border border-stone-200 bg-stone-50 pr-11 pl-4 font-normal outline-none transition focus:border-[#173f35] focus:bg-white">
      ...
      <label className="grid gap-2 text-sm font-bold text-zinc-800">
        ...
        <span className="relative">
          ...
          <textarea
            className="min-h-28 w-full resize-none rounded-md border border-stone-200 bg-stone-50 py-3 pr-11 pl-4 font-normal leading-7 outline-none transition placeholder:text-zinc-400 focus:border-[#173f35] focus:bg-white"
