  ...
  return (
    <article className="group overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
      <div className="relative aspect-[4/3] overflow-hidden bg-zinc-100">
        ...
        />
        <div className="absolute right-3 top-3 rounded-md bg-white/94 px-3 py-1 text-xs font-bold text-teal-800 shadow-sm">
      ...
      <div className="p-5">
        <div className="flex items-start justify-between gap-3">
          ...
          <MoveUpLeft className="mt-1 text-zinc-300 transition group-hover:text-teal-700" size={20} />
        </div>

        <p className="mt-5 text-lg font-black text-teal-800">
